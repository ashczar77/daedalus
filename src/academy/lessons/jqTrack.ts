...
export const jqLessons: LessonPack[] = [
  ...
  },
  {
    ...
    prose: [
      'Object fields use dot syntax: .text means "the value at key text".',
      'jq -r (raw) prints strings without JSON quotes - handy when you want plain text for the next tool in a pipe.',
